...
def generate_detailed_prompt(ocr_data):
    ...
    question = (
        ...
        "    - **Quantity**: Numeric (e.g., '1.0')\n"
        "    - **NetWeight**: Numeric (e.g., '0.070')\n"
        "    - **NetAmount**: Numeric (e.g., '160.28')\n"
        "    - **PricePerPiece**: Numeric (e.g., '160.28')\n"
        "19. **NetWeight**: Numeric (e.g., '55.000')\n"
        "20. **GrossWeight**: Numeric (if available)\n"
        "21. **NumberOfUnits**: Numeric (e.g., '1')\n"
        "22. **NumberOfPallets**: Numeric (if available)\n\n"
