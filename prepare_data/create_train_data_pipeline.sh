...
export PICKUP_IDS="160633,159675,159674,159565,159230,158943,158942,158156,157697,157696,157695,156047"
...
export ORDER_ITEM_FIELDS="Description,HsCode,HsCodeExport,Quantity,ArticleNumber,GrossWeight,NetWeight,CountryOfOrigin,NumberOfUnits,TypeOfUnit,PricePerPiece,NetAmount,Discount,DiscountPercentage"
